...
from app.schemas import (
    DigestOut, DigestPreviewOut, OverviewStats, RecommendationOut, WeakTopicOut, WeeklyStats,
)
...
@router.post("/digest/send-now", response_model=DigestOut)
...
def get_recommend(count: int = Query(default=1, ge=1, le=50),
